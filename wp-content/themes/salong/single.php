...
<section class="container wrapper">
  <div class="content-box left">
    <section class="page-head">
      ...
      <!-- 页面信息 -->
      <div class="info">
        <span class="category"><i class="icon-category"></i><?php the_category(', ') ?></span>
    ...
    <!-- 作者版本end -->
      <!-- 它季广告 -->
      <?php if(get_option('sl_ad1_img')){?>
      <div class="tajiad"><a href="<?php echo get_option('sl_ad1_link'); ?>" title="<?php echo get_option('sl_ad1_title'); ?>"><img src="<?php echo get_option('sl_ad1_img'); ?>" alt="<?php echo get_option('sl_ad1_title'); ?>"></a></div>
      <?php }?>
      <!-- 它季广告end -->
    <!-- 上下篇 -->
      <div class="pre-next">
